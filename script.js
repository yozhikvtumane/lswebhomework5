...
console.log("1. Print the number 5 to the console:");
console.log(5);

//2. Print your name to the console
console.log("2. Print your name to the console:");
console.log("John");
...
console.log("4. Print to the console how old you will be in 5 years");
console.log(myAge + 5);

//5. Store your favorite food as a variable called "myFavoriteFood"
var myFavoriteFood = "Burgers";
...
console.log("Print the remainder of 14 / 3 to the console");
console.log(14 % 3);

//8. Print the remainder of 829 / 13 to the console
console.log("Print the remainder of 829 / 13 to the console");
console.log(829 % 13);

//9. Create a for loop that counts from 0 to 130 by 3s
console.log("Create a for loop that counts from 0 to 130 by 3s");
for (var i = 0; i <= 130; i += 3) {
	console.log(i);
}

//10. Create a for loop that counts from 3 to 17 by 2s
console.log("Create a for loop that counts from 3 to 17 by 2s");
for (var i = 3; i <= 17; i += 2) {
	console.log(i);
}

//11. Create a for loop that counts from 100 to 3 by -1
console.log("Create a for loop that counts from 100 to 3 by -1");
for (var i = 100; i >= 3 ; i--) {
	console.log(i);
}

//12. Create a for loop that counts from 1 to 100 by 1s
console.log("Create a for loop that counts from 1 to 100 by 1s");
for (var i = 1; i <=100 ; i++) {
	console.log(i);
}

//13. Create a for loop that counts from 1 to 100, but instead of printing `i` prints `fizz` if the number is divisible by 5
console.log("Create a for loop that counts from 1 to 100, but instead of printing `i` prints `fizz` if the number is divisible by 5");
for (var i = 1; i <= 100; i++) {
	if (i % 5 == 0) {
		console.log("fizz");
	} else {
...
console.log("Create a for loop that counts from 1 to 100, but instead of printing `i` prints `buzz` if the number is divisible by 3");
for (var i = 1; i <= 100; i++) {
	if (i % 3 == 0) {
		console.log("buzz");
	} else {
...
console.log("Create a for loop that counts from 1 to 100, but instead of printing `i` prints `fizzbuzz` if the number is divisible by 15");
console.log("Output FizzBuzz if i % 15 == 0");
for (var i = 1; i <= 100; i++) {
	if (i % 15 == 0) {
